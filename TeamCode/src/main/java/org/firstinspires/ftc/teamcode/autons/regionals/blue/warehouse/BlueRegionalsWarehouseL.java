...
public class BlueRegionalsWarehouseL extends SequentialCommandGroup {
    public BlueRegionalsWarehouseL(Drivetrain drivetrain, Lift lift, Intake intake, DuckWheels duckWheels, Telemetry telemetry) {
        addCommands(
