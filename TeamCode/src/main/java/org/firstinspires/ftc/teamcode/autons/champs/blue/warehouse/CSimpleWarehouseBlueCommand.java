...
public class CSimpleWarehouseBlueCommand extends SequentialCommandGroup {
    public CSimpleWarehouseBlueCommand(Drivetrain drivetrain, Lift lift, Intake intake, DuckWheels duckWheels, Telemetry telemetry) {
        addCommands(
