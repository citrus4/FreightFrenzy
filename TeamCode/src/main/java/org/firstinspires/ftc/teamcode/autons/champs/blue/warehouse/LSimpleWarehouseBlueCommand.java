...
public class LSimpleWarehouseBlueCommand extends SequentialCommandGroup {
    public LSimpleWarehouseBlueCommand(Drivetrain drivetrain, Lift lift, Intake intake, DuckWheels duckWheels, Telemetry telemetry) {
        addCommands(
