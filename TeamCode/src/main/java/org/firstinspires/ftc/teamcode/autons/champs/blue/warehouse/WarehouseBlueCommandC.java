...
public class WarehouseBlueCommandC extends SequentialCommandGroup {
    public WarehouseBlueCommandC(Drivetrain drivetrain, Lift lift, Intake intake, DuckWheels duckWheels, Telemetry telemetry) {
        addCommands(
                //red warehouse
                //center(mid)
